...
def offer_signal(sender, instance, action, pk_set, **kwargs):
    if action == 'post_add':
        ...
        # sync_to_async(BidNotification.objects.create)(user = instance.owner, offer = last_offer)

# @receiver(post_save, sender=Notification)
# def notification_signal(sender, instance, created, **kwargs):
#     user = instance.user
#     if created:
#         personal_notifcations(str(user.id), "new notification")

# @receiver(post_save, sender=BidNotification)
# def bid_notification_signal(sender, instance, created, **kwargs):
#     user = instance.user
#     if created:
#         personal_notifcations(str(user.id), "new bid notification")
